...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_RESTAURANTS_ADD = "addname";
    ...
    private static final String DATABASE_CREATE_add = "create table "
            + TABLE_RESTAURANTS_ADD + "(" + COLUMN_ID
            + " integer primary key autoincrement, " + COLUMN_NAME
            + " text not null);";
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        database.execSQL(DATABASE_CREATE_add);
    }
